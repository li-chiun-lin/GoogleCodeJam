...
For example (and here is a hint!), our awesome translation algorithm includes the following three mappings: 'a' $\rightarrow$ 'y', 'o' $\rightarrow$ 'e', and 'z' $\rightarrow$ 'q'. This means that "a zoo" will become "y qee".
